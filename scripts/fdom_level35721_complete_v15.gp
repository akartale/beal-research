...
read("fdom.gp");
out=fileopen("/workspace/research/beal/data/fdom_level35721_loader_v15.log","w");
...
logpath="/workspace/research/beal/data/fdom_level35721_complete_v15.log";
runcomplete()={
  ...
  writebin("/workspace/research/beal/data/fdom_level35721_complete_checkpoint_v15.bin",res);
