...
beala=alginit(bealk,[385*qy^2-110*qy-935,275*qy^2-385*qy-1484]);filewrite(out,Str("LIB_beala=",type(beala)));
bealn=12;bealo=[matid(bealn),1];filewrite(out,Str("LIB_bealo=",type(bealo)));
