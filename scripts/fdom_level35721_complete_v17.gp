...
read("fdom.gp");
out=fileopen("/workspace/research/beal/data/fdom_level35721_loader_v17.log","w");
...
logpath="/workspace/research/beal/data/fdom_level35721_complete_v17.log";
runcomplete()={
  ...
  writebin("/workspace/research/beal/data/fdom_level35721_complete_checkpoint_v17.bin",res);
